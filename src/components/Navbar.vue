        ...
        <div class="flex items-center gap-6 px-2">
          ...
          <a href=""
            ...
            >
              ...
              />
              <path d="M74.7 47L31.9 94h36.7l42.8-47L68.6 0H31.9z" /></svg
          ></a>
        </div>
        <ul
    ...
    <nav class="bg-white shadow-md w-full">
      ...
      <div class="container max-w-[1920px] px-6 mx-auto h-[60px] flex logo">
        ...
        <div class="flex items-center justify-center gap-2 lg:gap-3 z-10">
          ...
          <a href="" class="hover:bg-[#CACACB] rounded-full p-1 hidden love"
            ><svg
              aria-hidden="true"
              focusable="false"
              viewBox="0 0 24 24"
          ...
          <a href="" class="hover:bg-[#CACACB] rounded-full p-1"
            ><svg
              aria-hidden="true"
              focusable="false"
              viewBox="0 0 24 24"
