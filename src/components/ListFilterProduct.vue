...
<template>
    <div class="mx-6 md:mx-12 mt-6">
        <div class="flex justify-between items-center mb-4">
            <div class="text-2xl font-bold">Menshoe (100)</div>
            <div class="flex justify-between items-center">
                <div class="px-8 flex items-center">
                    <div class="text-lg px-2">Filter</div>
                ...
                <div class="flex items-center">
                    <div class="text-lg px-2">Sort By1</div>
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="flex gap-4">
            <div class="hidden md:block w-1/4 bg-white p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 w-full gap-4">
                <div class="bg-white h-120">
                    <img src="https://cdn.thewirecutter.com/wp-content/media/2024/11/runningshoes-2048px-09528.jpg?auto=webp&quality=75&width=1024"
                        alt="Product Image" class="w-full h-80 object-cover mb-2 rounded">
                    <h3 class="text-lg font-semibold text-red-500">Just In</h3>
