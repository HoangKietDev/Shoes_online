...
const navigation = {
  ...
  Men: {
    subCategories: {
      ...
      'Discover Sport': {
        children: ['Running', 'Football', 'Basketball', 'Training and Gym', 'Tennis', 'Golf'],
      },
      'Accessories and Equipment': {
        children: ['All Accessories and Equipment', 'Bags and Backpacks', 'Headwear', 'Socks'],
      },
    },
  },
  Women: {
  ...
  Kids: {
    subCategories: {
      Featured: {
        children: ['New Releases', 'Best Sellers', 'Teens', 'EasyOn', 'Cold Weather'],
      },
      Shoes: {
        children: ['All Shoes', 'Lifestyle', 'Jordan', 'Football', 'Running', 'Basketball'],
      },
      Clothing: {
        children: [
          'All Clothing',
    ...
    <div class="absolute top-0 right-0 w-[320px] h-full bg-white z-100 overflow-y-scroll">
        ...
        <div class="w-full flex justify-between">
          <div class="flex items-center">
            <button type="button" @click="goBack" v-if="showBackButton">
              <svg aria-hidden="true" class="slide_out__previous_caret" focusable="false" viewBox="0 0 24 24" role="img"
          ...
          <button type="button" @click="toggleHam">
            <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" role="img" width="24px" height="24px"
              fill="none">
              <path stroke="currentColor" stroke-width="1.5" d="M18.973 5.027L5.028 18.972m0-13.945l13.944 13.945">
              </path>
            </svg>
          </button>
        </div>
      ...
      <div v-if="currentLevel === 'main'" class="h-full flex flex-col pl-8 pr-6 py-4 justify-start items-start">
        ...
        <ul class="w-full mt-12 translate-x-[-6px]">
          <li class="flex mb-4">
            <a href="">
              <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" role="img" width="30" height="30"
                fill="none">
          ...
          <li class="flex">
            <a href="">
              <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="-16.71 -23.5 144.82 141">
        ...
        <ul class="w-full mt-16">
          <p class="mb-8 text-[20px]/[24px] w-[230px]">
            Become a Nike Member for the best products, inspiration and stories in sport.
            <a href="">Learn more</a>
          </p>
          <div class="flex gap-2">
            <li>
              <router-link to="/signin" class="px-4 py-2 text-white font-medium bg-black rounded-2xl">Join
                Us</router-link>
            </li>
            <li>
        ...
        <ul class="w-full mt-16 pb-[120px] translate-x-[-6px]">
          <li class="mb-4">
            <a href="" class="flex">
              <svg aria-hidden="true" class="nav-icon mr-2" focusable="false" viewBox="0 0 24 24" role="img"
                width="24px" height="24px" fill="none" count="0">
          ...
          <li class="mb-4">
            <a href="" class="flex">
              <svg aria-hidden="true" class="mr-2" focusable="false" viewBox="0 0 24 24" role="img" width="24px"
      ...
      <!-- Parent -->
      <div v-else-if="currentLevel === 'parent'" class="h-full flex flex-col pl-8 pr-6 py-4 justify-start items-start">
        <ul class="w-full text-[24px]">
          <li class="mb-4">
      ...
      <!-- Child -->
      <div v-else-if="currentLevel === 'child'" class="h-full flex flex-col pl-8 pr-6 py-4 justify-start items-start">
        <ul class="w-full text-[24px]">
          <li>
            <span class="font-semibold mb-4 inline-block">{{ currentParent }}</span>
            <div v-for="childItem in navigation[currentGrandparent].subCategories[currentParent]
              .children" :key="childItem" class="py-2">
