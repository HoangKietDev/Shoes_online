    ...
    <div class="absolute top-0 right-0 w-[320px] h-full bg-white z-100 overflow-y-scroll">
        ...
        <div class="w-full flex justify-between">
          <div class="flex items-center">
            <button type="button" @click="goBack" v-if="showBackButton">
              <svg
                aria-hidden="true"
                class="slide_out__previous_caret"
                focusable="false"
                viewBox="0 0 24 24"
                role="img"
                width="24px"
        ...
        <ul class="w-full mt-16">
          ...
          <div class="flex gap-2">
            <li>
              <router-link
                to="/signin"
                class="px-4 py-2 text-white font-medium bg-black rounded-2xl"
                >Join Us</router-link
              >
            </li>
            <li>
      ...
      >
        <ul class="w-full text-[24px]">
          ...
          <li
            v-for="(_, key) in navigation[currentGrandparent].subCategories"
            :key="key"
            class="py-2"
          >
            <div
              class="flex items-center justify-between text-[1rem] text-[rgba(0,0,0,0.6)]"
      ...
      >
        <ul class="w-full text-[24px]">
          <li>
            ...
            <div
              v-for="childItem in navigation[currentGrandparent].subCategories[currentParent]
                .children"
              :key="childItem"
              class="py-2"
            >
